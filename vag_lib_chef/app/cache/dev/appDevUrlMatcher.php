...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            // app_default_blogindex
            if ($pathinfo === '/blogIndex') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::blogIndexAction',  '_route' => 'app_default_blogindex',);
            }

            // app_default_blogshow
            if ($pathinfo === '/blogShow') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::blogShowAction',  '_route' => 'app_default_blogshow',);
            }
